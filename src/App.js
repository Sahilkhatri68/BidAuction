  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/addproduct" element={<AddProducts/>}/>  {/* Staff adding products */}
        <Route path="/addauction" element={<AddAuction/>}/>  {/* Staff adding auction */}
        <Route path="/adduser" element={<AddUser/>}/>  {/* Staff adding new user */}
        <Route path="/editprofile" element={<EditProfile/>}/>  {/* Staff edit profile  */}
        <Route path="/viewauction" element={<ViewAuction/>}/>  {/* Staff view auction  */}
        <Route path="/viewproduct" element={<ViewProducts/>}/>  {/* Staff View Products  */}
        <Route path="/viewuser" element={<ViewUser/>}/>  {/* Staff View user  */}
        <Route path="/editproduct" element={<EditProduct/>}/>  {/* Staff Edit product  */}
        <Route path="/editauction" element={<EditAuction/>}/>  {/* Staff Edit auction  */}
        <Route path="/edituser" element={<EditUser/>}/>  {/* Staff Edit User  */}
        <Route path="/viewmore" element={<ViewMore/>}/>  {/* Bottom View More  */}
