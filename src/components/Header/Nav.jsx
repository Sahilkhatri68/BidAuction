                ...
                <div className='outside'>
                    <div className='MidItems'>
                        <div className='conttt'>
                            ...
                            <div className='lowerHead'><p className='para'>Mahindra</p></div>
                        </div>
                        ...
                        <div className='conttt'>
                            ...
                            <div className='lowerHead'><p className='para'>Hyundai</p></div>
                        </div>
                        <div className='conttt'>
                            ...
                            <div className='lowerHead'><p className='para'>Suzuki</p></div>
                        </div>
                        <div className='conttt'>
                            ...
                            <div className='lowerHead'><p className='para' >Kia</p></div>
                        </div>
                        <div className='conttt'>
                            ...
                            <div className='lowerHead'><p className='para'>Chevrolet</p></div>
                        </div>
                        <div className='conttt'>
                            ...
                            <div className='lowerHead'><p className='para'>MG </p></div>
                        </div>
                    </div></div>
            </div>
